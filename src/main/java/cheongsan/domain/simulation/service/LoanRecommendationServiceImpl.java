...
import cheongsan.domain.simulation.dto.LoanProductDTO;
...
import cheongsan.domain.simulation.mapper.LoanProductMapper;
...
public class LoanRecommendationServiceImpl implements LoanRecommendationService {
    ...
    private LoanProductDTO convertToDTO(Simulation entity) {
